...
void SdCard::init()
{
    ...
    SD_SPI->begin(SD_SCLK, SD_MISO, SD_MOSI); // SD_SPI.setFrequency(1000000);
 
	// if (!SD.begin(SD_CS, *SD_SPI, 80000000)) // SD-Card SS pin is 15
	// if (!SD.begin(SD_CS, *SD_SPI)) // SD-Card SS pin is 15
	// {
