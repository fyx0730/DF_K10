...
/**
 * Structure representing an open file in the file system.
 * This structure holds the necessary information to manage an open file,
 * including the file descriptor, the associated driver, and an optional cache.
 */
typedef struct {
    void * file_d;
    lv_fs_drv_t * drv;
